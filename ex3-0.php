...
// Requete composée
$statement = $connexion->query("SELECT * FROM  eleve AS e /* "e" est un "alias", il représente la table "eleve" */
...
foreach($results as $result){
    if(array_key_exists($result["id_eleve"] , $eleves)){ // Définition de la clé de l'array $eleves, qui est un array avec les données de id_eleves
